...
namespace UnityEngine.XR.Hands.Samples.GestureSample
{
    ...
    public class StaticHandGesture : MonoBehaviour
    {
        ...
        void Awake()
        {
            // ADD NULL CHECK: Only access m_Background if it is assigned
            ...
            {
                // Optional: Add a warning log to know this is happening
                Debug.LogWarning("StaticHandGesture on '" + gameObject.name + "': Background Image is not assigned. Gesture icon visualization will be skipped.");
            }
        }
        ...
        void OnJointsUpdated(XRHandJointsUpdatedEventArgs eventArgs)
        {
            ...
            else if (m_WasDetected && !detected)
            {
                ...
                // ADD NULL CHECK: Only access m_Background if it is assigned
                if (m_Background != null) // <--- Add this line
                { // <--- Add this line
